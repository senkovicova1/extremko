...
class TestStringMethods(unittest.TestCase):
    ...
    def test5_ZakladnyVypocet5(self):
        roman = RomanNumberWithZero()
        self.assertTrue(roman.calculator("I+I"))
        self.assertEqual(roman.getRomanNumber(), "II")

    def test5_AddZero(self):
        roman = RomanNumberWithZero()
        self.assertTrue(roman.calculator("IV + O"))
        self.assertEqual(roman.getRomanNumber(), "IV")

    def test5_AddToZero(self):
        roman = RomanNumberWithZero()
        self.assertTrue(roman.calculator("O + IV"))
        self.assertEqual(roman.getRomanNumber(), "IV")

    def test5_Rozdiel5(self):
        roman = RomanNumberWithZero()
        roman.calculator("MMDCCLXXXIII-MDCLXVI")
        self.assertEqual(roman.getRomanNumber(), "MCXVII")

    def test5_Delenie5(self):
        roman = RomanNumberWithZero()
        roman.calculator("MMMDC/MD")
        self.assertEqual(roman.getRomanNumber(), "II")

    def test5_Nasobenie5(self):
        roman = RomanNumberWithZero()
        roman.calculator("XIV*VI")
        self.assertEqual(roman.getRomanNumber(), "LXXXIV")

    def test5_Scitanie5(self):
        roman = RomanNumberWithZero()
        roman.calculator("L+XL")
        self.assertEqual(roman.getRomanNumber(), "XC")

    def test5_PrazdnyVyraz(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator(""))

    def test5_DvaOperatory(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("MMDC-*MD"))

    def test5_DvePatky(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("VV-I"))

    def test5_ZleCislo(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("I-MMMIM"))

    def test5_ChybaOperand(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("MXII"))

    def test5_ChybaDruhy(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("MMDCCLXXXII+"))

    def test5_ChybaPrvy(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("+MMDCCLXXXII"))

    def test5_Privela(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("MMDC-MD a"))

    def test5_DesiatkaZaPatkou(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("DM+III"))

    def test5_PatkaStvorka(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("VIV-I"))

    def test5_ZleUmiestnenie(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("MCMM+I"))

    def test5_NeznamyOperator5(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("X^II"))

    def test5_NeznamaCislica5(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("GL+V"))

    def test5_IXVplusI(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("IXV+I"))

    def test5_zlyOperator(self):
        roman = RomanNumberWithZero()
        self.assertFalse(roman.calculator("XII@I"))

    def test5_mensi(self):
        roman = RomanNumberWithZero("OIVXLC6MPQRSTUWz")
        roman.calculator("zzMM6CCLXXXIII - zzM6CLXVI")
        self.assertEqual(roman.getRomanNumber(), "MCXVII")

    def test5_vacsi(self):
        roman = RomanNumberWithZero("OIVXLCDMPQRSTUWY")
        roman.calculator("YYMDCLXVI - YYMMDCCLXXXIII")
        self.assertEqual(roman.getRomanNumber(), "-MCXVII")

    def test5_rovny(self):
        roman = RomanNumberWithZero("OIVXLCDMPQRSTUWY")
        roman.calculator(" - YYMMDCCLXXXIII - - YYMMDCCLXXXIII ")
        self.assertEqual(roman.getRomanNumber(), "O")

    def test5_Efektivita(self):
        roman = RomanNumberWithZero("OIV XLCDMPQRSTUWY")
        for i in range(1000):
